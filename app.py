...
from utils.visualization import generate_wordcloud, plot_top_orgs, plot_pie_chart
...
if option == "Twitter Sentiment Analysis":
    ...
    if 'df' in st.session_state and st.session_state.df is not None:
        ...
        upload_option = st.sidebar.radio("Choose an option", ("Visualization", "Predictions"))

        if upload_option == "Visualization":
